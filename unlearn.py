...
def run_rmu(
    ...
    return path, updated_model, frozen_model, tokenizer, forget_data_list, retain_data_list
...
if __name__ == "__main__":
    ...
    path, updated_model, frozen_model, tokenizer, forget_data_list, retain_data_list = run_rmu(
        updated_model,
        frozen_model,
        tokenizer,
        forget_data_list,
